...
export class GeminiService implements OnModuleInit {
  ...
  async generateCourseStructure(context: Array<{ role: string; content: string }>): Promise<CourseStructure> {
    try {
      ...
      const prompt = `
        ...
        Generate a complete course structure in this exact JSON format:
        {
          "title": "Specific and engaging title",
              ...
              "content": [
                {
                  ...
                  "description": "Clear content description"
                }
              ]
            }
          ],
        ...
        2. Make content practical and engaging
        3. Include 3-4 modules
        4. Each module should have 2-3 content items
        5. Mix different content types (video, document, quiz, assignment)
        6. Ensure all descriptions are clear and specific
        7. Make sure all JSON fields are properly formatted
      `;
